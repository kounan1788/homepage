...
export default function Page() {
    const basePrice = carBasePrices['/kcar/tantocustom'];
    ...
    const contactUrl = (() => {
        ...
        return buildContactUrl({
            category: 'ノレタ',
            lines: [
                '車種: ダイハツ タントカスタム（カスタム RS・2WD・660cc）',
                ...
                <div className="max-w-5xl mx-auto">
                    ...
                    <nav aria-label="パンくずリスト" className="mb-3">
                        <ol className="flex flex-wrap items-center text-xs text-slate-400">
                            ...
                            <li className="mx-2">›</li>
                            <li className="text-slate-200">ダイハツ タントカスタム</li>
                        </ol>
            ...
            <div className="max-w-5xl mx-auto px-4 md:px-8 py-8 pb-32">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-6">
                        ...
                        {/* ボーナス払いシミュレーター */}
                        <BonusPaymentSimulator principal={carLoanPrincipals['/kcar/tantocustom']} />
                    </div>
            ...
            <div className="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur border-t border-gray-200 z-40 pb-[env(safe-area-inset-bottom)]">
                <div className="max-w-5xl mx-auto px-4 py-3 flex items-center justify-between">
                    <div className="hidden md:block">
                        <div className="text-slate-800 font-bold">ダイハツ タントカスタム</div>
                        <div className="text-slate-500 text-sm">カスタム RS・2WD・660cc</div>
                    </div>
