...
export default function Page() {
    const basePrice = carBasePrices['/suv/xbee'];

    const colors: ColorOption[] = useMemo(() => [
        { name: 'ピュアホワイトパール', price: 900, colorCode: '#FFFFFF' },
    ...
    const options: VehicleOption[] = useMemo(() => [
        ...
        { name: 'ETC車載器（ビルトインタイプ）', price: 1100, category: 'ナビ・電装' },
        { name: 'アップグレードパッケージ装着車', price: 2500, category: 'パッケージ' },
    ...
    const contactUrl = (() => {
        ...
        return buildContactUrl({
            category: 'ノレタ',
            lines: [
                '車種: スズキ クロスビー（HYBRID MZ・2WD・1,000cc）',
                ...
                <div className="mx-auto max-w-5xl px-4 py-8 md:px-8">
                    ...
                    <nav aria-label="パンくずリスト" className="mb-4">
                        <ol className="flex flex-wrap items-center text-xs text-teal-200">
                            ...
                            <li className="mx-2 text-teal-400">›</li>
                            <li className="text-white">スズキ クロスビー</li>
                        </ol>
                    </nav>
            ...
            <main id="main" tabIndex={-1} className="mx-auto max-w-5xl px-4 pb-32 pt-8 md:px-8">
                <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                    ...
                    <div className="space-y-6">
                        ...
                        {/* ボーナス払いシミュレーター */}
                        <BonusPaymentSimulator principal={carLoanPrincipals['/suv/xbee']} />
                    </div>
            ...
            <div className="fixed bottom-0 left-0 right-0 z-40 border-t border-rule bg-white/95 backdrop-blur pb-[env(safe-area-inset-bottom)]">
                <div className="mx-auto flex max-w-5xl items-center justify-between gap-4 px-4 py-3">
                    <div className="hidden md:block">
                        <div className="font-bold text-gray-800">スズキ クロスビー</div>
                        <div className="text-sm text-gray-500">HYBRID MZ ／ 2WD ／ 1,000cc</div>
                    </div>
