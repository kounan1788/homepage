...
export default function Page() {
    ...
    const carData: Record<CarCategory, Car[]> = {
        SUV: [
            ...
            { name: 'VEZEL', price: '45,000円～', image: '/cars/vezel.jpg', route: '/vezel' },
            {
                name: 'カローラクロス',
                price: '45,000円～',
            ...
            { name: 'RAV4', price: '58,000円～', image: '/cars/rav4.jpg', route: '/rav4' },
            {
                name: 'ランクル 250',
                price: '62,000円～',
            ...
            { name: 'クラウン', price: '80,500円～', image: '/cars/crown.jpg', route: '/crown' },
            { name: 'NX', price: '86,000円～', image: '/cars/nx.jpg', route: '/nx' },
        ],

        MINIVAN: [
            { name: 'ノア', price: '45,000円～', image: '/cars/noah.jpg', route: '/noah' },
            { name: 'ヴォクシー', price: '45,000円～', image: '/cars/voxy.jpg', route: '/voxy' },
            {
                name: 'アルファード',
                price: '72,800円～',
        ...
        KCAR: [
            { name: 'NBOX カスタム', price: '24,000円～', image: '/cars/nbox.jpg', route: '/nbox' },
            {
                name: 'タントカスタム',
                price: '22,000円～',
            ...
            { name: 'ジムニー', price: '22,000円～', image: '/cars/jimny.jpg', route: '/jimny' },
        ],
    };
